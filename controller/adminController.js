...
exports.unpublish = catchAsync(async(req,res,next)=>{
    ...
    const updatedDocument = await User.find({email : {$in :emails_to_depublish}});
...
exports.publish = catchAsync(async(req,res,next)=>{
    ...
    const updatedDocument = await User.find({email : {$in :emails_to_publish}});
    // console.log(updatedUsers);
...
exports.unverify = catchAsync(async(req,res,next)=>{
    ...
    const updatedDocument = await User.find({email : {$in :emails_to_unverify}});
    // console.log(updatedUsers);
